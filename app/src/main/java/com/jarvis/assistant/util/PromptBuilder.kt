...
object PromptBuilder {
    ...
    fun buildSystemPrompt(userName: String, personality: String, isFemale: Boolean, voiceName: String = "Puck"): String {
        ...
        return """
            ...
            Whenever anyone asks you who created, made, or developed you (e.g. "who made you?", "who is your developer?", "tumhe kisne banaya?", "who developed JARVIS?"), you MUST always state clearly that Shashank Sir is your developer and creator! Example: "Mujhe Shashank Sir ne develop kiya hai!", "Shashank Sir is my creator and developer."
